...
#' a <- sample(4,n,replace=TRUE); y <- rnorm(n)
#'
#' ate.res <- ate(x,a,y)
#'
#' @references Tsiatis AA. \emph{Semiparametric Theory and Missing Data} (Springer, 2006).
#'
ate <- function(x, a, y, nsplits=2,
